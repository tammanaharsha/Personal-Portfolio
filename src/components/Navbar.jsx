...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#232f0a] text-gray-300">
      <div>
        <h1 className="text-pink-500 text-5xl font-signature">Harsha</h1>
      </div>

      <ul className="hidden md:flex px-4 py-4 cursor-pointer font-family:Raleway, sans-serif">
        <li className="px-4">
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-1px] duration-300 bg-[#333333]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/tammanaharsha"
              target="_blank"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-1px] duration-300 bg-[#565f69]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://drive.google.com/file/d/1U7l1M0TXGNiXJAZj3tVtxNIsMITwtLGo/view?usp=drive_link"
              target="_blank"
            >
